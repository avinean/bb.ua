	...
	.footer
		.inner-wrapper
			.footer-body
				...
				.contacts.links
					...
					.addr
						a.facebook-link(href='https://www.facebook.com/vkblagobud' target='_blank')
							i.fab.fa-facebook.snow
		...
		.footer-foot
			.inner-wrapper
				...
				div
					router-link(to='/policy') Політика конфіденційності
				div
...
<style lang="scss" scoped src="@/scss/parts/footer.scss"></style>